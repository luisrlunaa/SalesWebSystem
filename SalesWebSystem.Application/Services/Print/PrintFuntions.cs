...
namespace SalesWebSystem.Application.Services.Print
{
    public class PrintFunctions : IPrintFunctions
    {
        ...
        public PrintFunctions(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public void tickFuntion()
        {
            ...
            //var Empresa = _httpContextAccessor.HttpContext.Session.Get<NomEmp>(ConstantsSession.DataBusiness);
            //var Empleado = _httpContextAccessor.HttpContext.Session.Get<Empleado>(ConstantsSession.Employee);
            //PrintView = _httpContextAccessor.HttpContext.Session.Get<PrintViewModel>(ConstantsSession.Print);
            //if (PrintView != null)
            //{
            //    //cabecera del ticket.
